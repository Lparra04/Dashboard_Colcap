...
ui <- dashboardPage(
  dashboardHeader(title = span("Visualizador Acciones Colombia", align="center", #Titulo superior izquierdo.
  ...
  dashboardBody(
    tabsetPanel(
      tabPanel(tabName = "Base de datos", 
               h1("Base de datos"),
               ...
               fluidRow(
                 tabBox(width = 12,title = "Bases de datos",
                        ...
                        tabPanel("Base original", dataTableOutput("Base")), #Se crea un espacio o pesta̱a llamada "Base original", en donde se muestra el Base de datosrame "Base". 
                        tabPanel("Resumen por dia", dataTableOutput("Base_d"))) #Se crea un espacio o pesta̱a llamada "Resumen por dia", en donde se muestra el Base de datosrame "Base_d".
               )
      )
      ,
      tabPanel(tabName = "Retorno Acciones",
               h2("Retorno Acciones"),
               fluidRow(
                 column(3,
